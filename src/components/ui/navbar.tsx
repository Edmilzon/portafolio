      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-purple-500/20 rounded-lg bg-slate-800/50 backdrop-blur-sm md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-transparent">
            ...
            <li>
              <Link href="#" className="block py-2 px-3 text-gray-300 rounded-lg hover:bg-purple-800/50 md:hover:bg-transparent md:border-0 md:hover:text-white md:p-0 md:hover:bg-gradient-to-r md:hover:from-purple-600/20 md:hover:to-pink-600/20 md:hover:rounded-lg transition-all duration-300 font-medium relative group">
            ...
            <li>
              <Link href="#" className="block py-2 px-3 text-gray-300 rounded-lg hover:bg-purple-800/50 md:hover:bg-transparent md:border-0 md:hover:text-white md:p-0 md:hover:bg-gradient-to-r md:hover:from-pink-600/20 md:hover:to-orange-600/20 md:hover:rounded-lg transition-all duration-300 font-medium relative group">
            ...
            <li>
              <Link href="#" className="block py-2 px-3 text-gray-300 rounded-lg hover:bg-purple-800/50 md:hover:bg-transparent md:border-0 md:hover:text-white md:p-0 md:hover:bg-gradient-to-r md:hover:from-orange-600/20 md:hover:to-red-600/20 md:hover:rounded-lg transition-all duration-300 font-medium relative group">
            ...
            <li>
              <Link href="#" className="block py-2 px-3 text-gray-300 rounded-lg hover:bg-purple-800/50 md:hover:bg-transparent md:border-0 md:hover:text-white md:p-0 md:hover:bg-gradient-to-r md:hover:from-red-600/20 md:hover:to-purple-600/20 md:hover:rounded-lg transition-all duration-300 font-medium relative group">
